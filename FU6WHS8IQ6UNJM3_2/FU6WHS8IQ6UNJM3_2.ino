...
#define OUTPUT_READABLE_YAWPITCHROLL affichage
...
void loop() {
    ...
    while (!mpuInterrupt && fifoCount < packetSize) {
      ...
      if (abs(int(rc_values[RC_CH5])-1500)<env){
          myservoPitch.write(int(ypr[1] * 180/M_PI)+90); 
          myservoRoll.write(int(ypr[2] * -180/M_PI)+90); 
          myservoRoll.write(int(ypr[0] * -180/M_PI)+90); 
         ...
         //myservoRoll.write(int((dtRoll-1000)*18/100)); 
         //myservoPitch.write(int((dtPitch-1000)*18/100)); 
         //myservoYaw.write(int((dtYaw-1000)*18/100)); 
         //myservoThrotle.write(int((dtThrotle-1000)*18/100)); 
